...
<div class="content">
    <div class="card">
        ...
        <div class="card-footer">
            ...
            <div class="card-body">
                <li>
                    <p><strong>Quem recusou:</strong> {{ $solicitar->id_recusado }}</p>
                </li>
                <li>
                    <p><strong>Porque recusou:</strong> {{ $solicitar->motivo_recusado }}</p>
                </li>
                <li>
                    <p><strong>Quando recusou:</strong> {{ $solicitar->hora_recusado }}</p>
                </li>
                <a class="btn btn-secundary" onclick="history.back()">
                    <i class="fas fa-arrow-left"></i> Voltar
                </a>
